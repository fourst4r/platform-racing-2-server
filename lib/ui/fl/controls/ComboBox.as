...
package fl.controls {
	...
	public class ComboBox extends UIComponent implements IFocusManagerComponent {
		...
		public function close():void {
			...
			var myForm:DisplayObjectContainer = focusManager != null ? focusManager.form : null;
			if (myForm != null)
			{
				myForm.removeEventListener(MouseEvent.MOUSE_DOWN, onStageClick);
			}
			isOpen = false;
			// Guard against duplicate close calls removing the list twice.
			if (myForm != null && myForm.contains(list))
			{

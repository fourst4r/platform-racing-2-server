...
CREATE TABLE level_backups (backup_id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, level_id INT NOT NULL, title VARCHAR(50) NOT NULL, version MEDIUMINT NOT NULL, date datetime NOT NULL, live TINYINT(3) DEFAULT 0 NOT NULL, rating FLOAT(12) DEFAULT 0 NOT NULL, votes INT DEFAULT 0 NOT NULL, note TINYTEXT NOT NULL, min_level TINYINT(3) DEFAULT 0 NOT NULL, song TINYINT(3) DEFAULT 0 NOT NULL, play_count INT DEFAULT 0 NOT NULL, pass VARCHAR(40) NULL, type VARCHAR(1) DEFAULT 'r' NOT NULL, bad_hats VARCHAR(100) DEFAULT '' NOT NULL, CONSTRAINT PK_LEVEL_BACKUPS PRIMARY KEY (backup_id));

...
class Prizes
{
    ...
    public static function init()
    {
        ...
        self::$TACO_FEET = new Prize(self::TYPE_FEET, Feet::TACO, 'Taco Feet');
        self::$SLENDER_FEET = new Prize(self::TYPE_FEET, Feet::SLENDER, 'Slender Feet');
        self::$SANTA_FEET = new Prize(self::TYPE_FEET, Feet::SANTA, 'Santa Feet');
